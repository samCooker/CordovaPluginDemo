package com.cookie.datepicker.views;
...
import com.cookie.datepicker.bizs.decors.DPDecor;
...
import com.cookie.datepicker.utils.MeasureUtil;
...
public class DatePicker extends LinearLayout {
    ...
    public DatePicker(Context context, AttributeSet attrs) {
        ...
        tvTime.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 30);

        TextView tvTimeSep = new TextView(context);
        tvTimeSep.setText(":");
        ...
        llTime.addView(tvTime,lpTime);
        llTime.addView(hourPicker,lpTime);
        llTime.addView(tvTimeSep,lpTime);
        llTime.addView(minuPicker,lpTime);
        addView(llTime, llParams);
    }
